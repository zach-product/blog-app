...
const Post = props => (
    <tr>
        ...
        <td className="align-middle">
            <Link className="btn btn-secondary" to={"/admin/posts/edit/"+props.post._id}><i className="fa fa-edit m-2"></i></Link>
            <Link className="btn btn-success ml-2" to={"/admin/posts/preview/"+props.post._id}><i className="fa fa-eye m-2"></i></Link>
        ...
        return (
            <div className="container" style={stickyHeader}>
                ...
                <table className="table table-fixed" >
                    <thead>
                        <tr>
                            <th style={{ width: '20%' }} scope="col">Header Pic</th>
                            <th style={{ width: '20%' }} scope="col">Title</th>
                            <th style={{ width: '20%' }} scope="col">Topics</th>
